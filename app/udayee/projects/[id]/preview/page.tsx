...
//                     [...project.milestones]
//                       .sort((a, b) => {
//                         const statusOrder = { "completed": 0, "in-progress": 1, "declined": 2, "planned": 3 };
...
//                                 <Target className="h-3 w-3" />
//                               </div>
//                             ) : typeof milestone === "object" && milestone.status === "declined" ? (
//                               <div className="bg-red-500/20 text-red-500 w-6 h-6 rounded-full flex items-center justify-center">
//                                 <Target className="h-3 w-3" />
//                               </div>
//                             ) : (
...
//                               </p>
//                               {/* {typeof milestone === "object" && milestone.status === "declined" && milestone.declineReason && (
//                                 <p className="text-sm text-red-600 mt-2 italic">
//                                   Decline reason: {milestone.declineReason}
//                                 </p>
//                               )} */}
//                             </div>
...
//                     } 
//                     // else if (milestoneObj.status === 'declined' && milestoneObj.declinedAt) {
//                     //   dateValue = new Date(milestoneObj.declinedAt).toLocaleDateString();
//                     // } 
...
//                           ) : milestoneObj.status === 'declined' ? (
//                             <Target className="h-3 w-3 text-red-500" />
//                           ) : (
//                             <Clock className="h-3 w-3 text-muted-foreground" />
//                           )}
//                           <span className={milestoneObj.status === 'declined' ? 'line-through text-red-500' : ''}>
//                             {milestoneObj.title || `Milestone ${index + 1}`}
//                           </span>
//                         </div>
